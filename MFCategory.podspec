#
#  Be sure to run `pod spec lint MFCategory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://github.com/GodzzZZZ/MFCategory"
  ...
  s.source       = { :git => "https://github.com/GodzzZZZ/MFCategory.git", :tag => "#{s.version}" }
